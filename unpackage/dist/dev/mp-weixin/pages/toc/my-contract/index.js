...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const handleClick = (payload) => {
      var _a, _b, _c;
      const img = ((_a = payload == null ? void 0 : payload.fieldList) == null ? void 0 : _a.contract_scan_image) || [];
      const id = ((_b = img[0]) == null ? void 0 : _b.attach_im_id) || "";
      const mediaType = ((_c = img[0]) == null ? void 0 : _c.attach_suffix) === "pdf" ? "pdf" : "img";
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "/Users/mbp/Documents/item/HBuilderX/hq-uni/pages/toc/my-contract/index.vue"]]);
